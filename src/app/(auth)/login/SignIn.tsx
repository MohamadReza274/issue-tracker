...
import useLoginForm, {LoginFormSchemaType} from "@/app/(auth)/login/useLoginForm";
...
const SignIn = () => {
    ...
    const handleSubmitForm: SubmitHandler<LoginFormSchemaType> = (values) => {
        console.log(values);
        reset();
    }
    return (<form className="space-y-6" onSubmit={handleSubmit(handleSubmitForm)}>
        <div>
            <label htmlFor="email"
