...
const DeleteIssueButton = ({issueId}:Props) => {
    ...
    return (
        <>
            <button
                className="flex gap-x-2 items-center border border-red-400 rounded-md px-4 py-1 text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-500"
                            ...
                            <div className="bg-white dark:bg-gray-800 dark:text-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        <DialogTitle as="h3" className="text-base font-semibold text-gray-900 dark:text-gray-200">
                                            Delete Issue
                                        </DialogTitle>
                                        <div className="mt-2">
