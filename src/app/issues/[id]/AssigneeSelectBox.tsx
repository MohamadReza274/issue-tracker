...
const people = [
    {id: '1', name: 'Wade Cooper', email: "wadecooper@gmail.com"},
    {id: '2', name: 'Arlene Mccoy', email: "arlene-mccoy@gmail.com"},
]
...
const AssigneeSelectBox = ({user}:Props) => {
            ...
            <ChevronUpDownIcon aria-hidden="true" className="h-5 w-5 text-gray-400"/>
                ...
                >
                    {people.map((person) => (
                        ...
                        >
                            <span
                                className="block truncate font-normal group-data-[selected]:font-semibold">{person.name}</span>
