...
const AssigneeSelectBox = ({issue, user, users}: Props) => {
    const [selectedUser, setUser] = useState<User | null>(user || null);
    ...
    return (
        <Listbox onChange={handleChangeSelectedUser} value={selectedUser?.id || ""}>
            ...
            <div className="relative">
                <ListboxButton
                    className="relative w-full cursor-default rounded-md bg-white dark:bg-transparent dark:text-gray-200 py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
